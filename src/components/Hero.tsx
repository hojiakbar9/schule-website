...
const Hero = () => {
  return (
    <div className="relative w-full min-h-[600px] h-screen overflow-hidden">
      {/* Background Image */}
      <img
        className="absolute inset-0 h-full w-full object-cover animate-[var(--animate-fade-in-scale)]"
        src="src/assets/quran-background.jpg"
        alt="Hero background"
      />
      <div className="absolute inset-0 bg-black/40 animate-[var(--animate-fade-in-scale)]"></div>
      ...
      <div className="relative mx-5 text-white flex md:ml-2 lg:ml-10 flex-col z-10 h-full justify-center max-w-[630px]">
        ...
        <div className="px-4 animate-[var(--animate-slide-in-up)]">
